...
lost_kingdoms_ii_location = {}
lost_kingdoms_ii_location.__index = lost_kingdoms_ii_location
...
function lost_kingdoms_ii_location.new(name)
    local self = setmetatable({}, lost_kingdoms_ii_location)
    if name then
...
function lost_kingdoms_ii_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = lost_kingdoms_ii_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
function lost_kingdoms_ii_location:connect_two_ways(exit, rule)
...
function lost_kingdoms_ii_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function lost_kingdoms_ii_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function lost_kingdoms_ii_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function lost_kingdoms_ii_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function lost_kingdoms_ii_location:accessibility()
...
-- 
function lost_kingdoms_ii_location:discover(accessibility, keys)
