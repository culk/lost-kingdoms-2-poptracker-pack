...
ICON_BY_LEVEL = {
    ...
    ["Kadishu"] = "images/items/levels/kadishu.png",
    ...
    ["Sacred Battle Arena 1"] = "images/items/levels/sacred_battle_arena.png",
    ...
    ["Alanjeh Castle"] = "images/items/levels/alanjeh_castle.png",
